...
$(function () {
    ...
    var $nav2 = $nav.clone().attr('id', 'nav2').addClass('navbar-fixed-bottom').css({
        bottom: '-' + navHeight + 'px'
    }).appendTo('body');
...
},{"./bootstrap-fixes":90,"./header-anchors":91,"./nospam":92,"./para-fade":93,"babel/polyfill":89}],2:[function(require,module,exports){
(function (global){
"use strict";
